...
class TopK:
    ...
    def __init__(self, model_name, model, dataset_name, dev_dataset, test_dataset, sample_num, temperature):
        self.system_prompt = """Read the following question and reason step-by-step to formulate 2 best guesses and probability that each is correct. {description}
...
{{
  ...
  "answers": [
    ...
    {{"candidate": "second most likely guess", "probability": 0.0-1.0}}
        ...
        self.save_path = f"{config.OUTPUT_DIR}/topk/{dataset_name}/{model_name}.json"
